...
-- 2a) Workspaces (folders) to organize panoramas + share as a bundle
...
-- 8) Grant first admin: run after creating your first user, set their profile to admin
-- update public.profiles set role = 'admin' where user_id = 'YOUR-AUTH-USER-UUID';
-- (Optional) Grant first superadmin:
-- update public.profiles set role = 'superadmin' where user_id = 'YOUR-AUTH-USER-UUID';

-- 9) Buy interests (captured from customer plot cart checkout; managed in CRM)
