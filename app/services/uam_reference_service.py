...
CLIENT_MEMBER_ROLE_INTERNAL_BROKER = 'internal_broker'
CLIENT_MEMBER_ROLE_EXTERNAL_BROKER = 'external_broker'
CLIENT_MEMBER_ROLE_LEGACY_BROKER = 'broker'

CLIENT_MEMBER_ROLE_ALIASES = {
    CLIENT_MEMBER_ROLE_LEGACY_BROKER: CLIENT_MEMBER_ROLE_EXTERNAL_BROKER,
...
CLIENT_MEMBER_REFERENCE_ROLE_LABELS = {
    ...
    CLIENT_MEMBER_ROLE_INTERNAL_BROKER: 'Internal Broker',
    CLIENT_MEMBER_ROLE_EXTERNAL_BROKER: 'External Broker',
}
...
def _project_reference_users(sb, workspace_id=None, panorama_id=None, client_id=None):
    ...
    out_by_user = {}
    role_priority = {
        CLIENT_MEMBER_ROLE_EXTERNAL_BROKER: 0,
        CLIENT_MEMBER_ROLE_INTERNAL_BROKER: 1,
